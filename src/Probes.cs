...
namespace ProfLog
{
    public static class Probes
    {
        ...
        public static void PostGroupTimestamps(long __state)
        {
            if (__state != 0L)
            {
                Counters.Add(Pr.GroupTimestamps, __state);
            }
        }
        ...
        public static void PostRemoveGrouped(long __state)
        {
            if (__state != 0L)
            {
                Counters.Add(Pr.RemoveGrouped, __state);
            }
        }
